...
import com.example.krasrakas.databinding.ActivityDetailStatusBinding;

public class DetailStatus extends AppCompatActivity {

    ActivityDetailStatusBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityDetailStatusBinding.inflate(getLayoutInflater());
